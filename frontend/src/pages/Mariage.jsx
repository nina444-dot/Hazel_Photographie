...
const Mariage = () => {
  ...
  return (
    <div className="bg-hazel-light h-screen max-h-screen font-cormorant text-hazel-rust w-full overflow-x-hidden overflow-y-scroll">
      
      <Navbar />

      {/* IMG BACKGROUND */}
      <section 
        className="relative h-[85vh] bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center px-4" 
        style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), url(${mariage1})` }}
      >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10 px-8 max-w-7xl mx-auto mb-24">
        <div className="aspect-[3/4] bg-cover bg-center rounded-sm shadow-sm" style={{ backgroundImage: `url(${mariage2})` }}></div>
        <div className="aspect-[3/4] bg-cover bg-center rounded-sm shadow-sm" style={{ backgroundImage: `url(${mariage3})` }}></div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl mx-auto items-stretch">
  ...
  <div className="bg-[#B6856B] md:bg-hazel-rust p-10 rounded-2xl shadow-sm flex flex-col justify-between text-center min-h-[660px]">
    ...
    <div className="mt-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 text-base italic">
              {["Moins de 50", "50 - 100", "100 - 150", "Plus de 150"].map((option) => (
                <label key={option} className={`flex items-center space-x-2 border px-5 py-2 rounded-full cursor-pointer transition-all ${formData.nombreInvites === option ? "bg-hazel-rust text-hazel-light border-hazel-rust" : "border-hazel-rust/40 hover:bg-hazel-rust/70"}`}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 text-base italic">
              {["Oui", "En cours", "Pas encore"].map((option) => (
                <label key={option} className={`flex items-center space-x-2 border px-5 py-2 rounded-full cursor-pointer transition-all ${formData.lieuReserve === option ? "bg-hazel-rust text-hazel-light border-hazel-rust" : "border-hazel-rust/40 hover:bg-hazel-rust/70"}`}>
      ...
      {/* BAS DE PAGE */}
      <section className="bg-hazel-light pt-12 pb-24 md:pt-20 md:pb-36 w-full">
        <div className="w-full bg-hazel-rust text-hazel-light px-6 py-12 md:py-24">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative">
            ...
            {/* Photo 2 */}
            <div className="md:col-span-5 flex justify-center md:justify-start mt-6 md:mt-0 md:mb-[-9rem] z-20">
              <div 
                className="w-64 h-80 bg-cover bg-center rounded-sm shadow-xl" 
